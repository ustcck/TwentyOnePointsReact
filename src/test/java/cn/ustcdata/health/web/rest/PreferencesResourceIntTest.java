...
import cn.ustcdata.health.repository.PreferencesRepository;
import cn.ustcdata.health.repository.search.PreferencesSearchRepository;
...
import cn.ustcdata.health.domain.enumeration.Units;
/**
...
public class PreferencesResourceIntTest {
     ...
     *
     * @see cn.ustcdata.health.repository.search.PreferencesSearchRepositoryMockConfiguration
     */
    @Autowired
