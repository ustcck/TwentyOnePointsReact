package cn.ustcdata.health.web.rest;

import cn.ustcdata.health.TwentyOnePointsReactApp;

import cn.ustcdata.health.domain.Weight;
import cn.ustcdata.health.repository.WeightRepository;
import cn.ustcdata.health.repository.search.WeightSearchRepository;
import cn.ustcdata.health.web.rest.errors.ExceptionTranslator;
...
import static cn.ustcdata.health.web.rest.TestUtil.sameInstant;
import static cn.ustcdata.health.web.rest.TestUtil.createFormattingConversionService;
...
public class WeightResourceIntTest {
    ...
    private static final Double DEFAULT_WEIGTH = 1D;
    private static final Double UPDATED_WEIGTH = 2D;
    ...
    /**
     * This repository is mocked in the cn.ustcdata.health.repository.search test package.
     *
     * @see cn.ustcdata.health.repository.search.WeightSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createWeight() throws Exception {
        ...
        assertThat(testWeight.getWeigth()).isEqualTo(DEFAULT_WEIGTH);
    ...
    @Test
    @Transactional
    public void checkWeigthIsRequired() throws Exception {
        int databaseSizeBeforeTest = weightRepository.findAll().size();
        // set the field null
        weight.setWeigth(null);
    ...
    public void getAllWeights() throws Exception {
        ...
        restWeightMockMvc.perform(get("/api/weights?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].weigth").value(hasItem(DEFAULT_WEIGTH.doubleValue())));
    }
    ...
    public void getWeight() throws Exception {
        ...
        restWeightMockMvc.perform(get("/api/weights/{id}", weight.getId()))
            ...
            .andExpect(jsonPath("$.weigth").value(DEFAULT_WEIGTH.doubleValue()));
    }
    @Test
    @Transactional
    ...
    public void updateWeight() throws Exception {
        ...
        assertThat(testWeight.getWeigth()).isEqualTo(UPDATED_WEIGTH);
